      ...
      <div className="min-h-screen px-4 py-24 bg-white sm:px-6 lg:px-8 scroll-mt-0" id="pricing">
         <div className="mx-auto max-w-7xl">
            ...
            <p className="mb-16 text-lg text-center text-gray-600 md:text-xl">
               Buka potensi penuh layanan kami dengan paket yang disesuaikan
            </p>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-8">
               {plans.map((plan, index) => (
                  <div
                     key={index}
                     className={`relative ${plan.popular ? "lg:-mt-8 lg:mb-8" : ""} bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-3xl hover:-translate-y-2`}
                  >
                     {plan.popular && (
                     ...
                     <div className="p-8 bg-gradient-to-br from-blue-500 to-blue-800 text-white">
                        {plan.icon}
                        <h3 className="text-2xl font-bold mb-2 text-white">{plan.name}</h3>
                        <p className="text-5xl font-extrabold mb-2 text-white">{plan.price}K</p>
                        <p className="text-base text-blue-100 text-gray-600'">{plan.description}</p>
                     </div>
                     <div className="p-8">
                        ...
                        <Button
                           ...
                           className={`w-full py-6 ${plan && "bg-gradient-to-r from-blue-500 to-blue-800 hover:from-blue-600 hover:to-blue-900"} text-white font-semibold rounded-xl transition-colors duration-300 text-lg`}
                        >
                           Pilih {plan.name}
                        </Button>
                     </div>
